...
const groups=[
 {id:"work",label:"Работа сегодня",icon:LayoutDashboard,items:[["dashboard","Обзор",LayoutDashboard],["expedition","Экспедитор",Truck],["production","Производство",Factory],["shipments","Отгрузки",Truck],["reconciliation","Сверка",ClipboardList],["procurement","Снабженец",ShoppingCart]]},
