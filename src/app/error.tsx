...
const explanations:Record<string,{title:string;description:string;checks:string[]}>={
 production:{title:"Не удалось выпустить партию",description:"Производство разрешает отрицательные остатки сырья; ошибка связана с другими данными партии.",checks:["Убедитесь, что количество продукции больше нуля.","Проверьте, что у продукции заполнена рецептура.","Повторите операцию; списание сырья и приход продукции выполняются одной транзакцией."]},
