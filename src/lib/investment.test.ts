...
test("investor earns only after the official start",()=>{assert.equal(calculateInvestorEarnings(1857,40,true),742.8);assert.equal(calculateInvestorEarnings(1857,40,false),0);assert.equal(calculateInvestorEarnings(-500,40,true),0)});
